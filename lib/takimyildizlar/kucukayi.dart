...
class KucukAyi extends StatefulWidget {
  const KucukAyi({Key? key}) : super(key: key);

  @override
  State<KucukAyi> createState() => _KucukAyiState();
}

class _KucukAyiState extends State<KucukAyi> {
  @override
