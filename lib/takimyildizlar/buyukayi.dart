...
class BuyukAyi extends StatefulWidget {
  const BuyukAyi({Key? key}) : super(key: key);

  @override
  State<BuyukAyi> createState() => _BuyukAyiState();
}

class _BuyukAyiState extends State<BuyukAyi> {
  @override
